			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading">
						<div style="text-align: center;">REGISTRAR PRODUCTO</div>
					</div>
						...
						<div class="col-md-8">
							...
							<div class="col-xs-6">
								...
								<div class="form-group">
									...
									data-validacion-tipo="requerido|numero"/>
								</div>
								...
								<button type="submit" name="addproducto" class="btn btn-primary">Guardar</button>
