			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading">
						<div style="text-align: center;">REGISTRAR PROVEEDOR</div>
					</div>
						...
						<div class="col-md-8">
							...
							<div class="col-xs-6">
								<div class="form-group">
									...
									<input type="text" class="form-control" placeholder="Nombre del Proveedor" name ="proveedor" autofocus="true" data-validacion-tipo="requerido|min:3"/>
								</div>
							...
							<div class="col-xs-6">
								<div class="form-group">
									...
									<input type="text" class="form-control" placeholder="Nombres del Contacto" name ="nombre" autofocus="true" data-validacion-tipo="requerido|min:3"/>
								</div>
																
								<div class="form-group">
									<label >Apellidos del Contacto</label>
									<input type="text" class="form-control" placeholder="Apellidos del contacto" name ="apellido" data-validacion-tipo="requerido|min:3"/>
								</div>
								...
								<button type="submit" name="addproveedor" class="btn btn-primary">Guardar</button>
